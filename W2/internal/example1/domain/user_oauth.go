...
//go:generate replacer -afterprefix 'Id" form' 'Id,string" form' type user_oauth.go
//go:generate replacer -afterprefix 'json:"id"' 'json:"id,string"' type user_oauth.go
//go:generate replacer -afterprefix 'By" form' 'By,string" form' type user_oauth.go
