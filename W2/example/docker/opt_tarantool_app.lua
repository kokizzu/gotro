...
-- source: docker exec -it example_tarantool1_1 cat /usr/local/bin/tarantool-entrypoint.lua

-- prevent serialization error when migrating:
-- https://github.com/tarantool/go-tarantool/issues/94
