...
// TODO: replace postgresql functions (->>) to mysql version (json_extract), see: https://dev.mysql.com/doc/refman/5.7/en/json.html
// TODO: replace postgresql datatypes to mysql version
